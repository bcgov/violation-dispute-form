...
def send_email(recipient_email: str, pdf_data: bytes, pdf_name: str):
    ...
    <p>Hi,<br></p>
       ...
       <p>If you want to learn more about the hearing process, please visit the Provincial Court of British Columbia's website and read their Guide to Disputing a Ticket which is found here: https://www.provincialcourt.bc.ca/downloads/Traffic/Traffic%20Court%20Guide.pdf
