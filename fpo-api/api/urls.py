...
from .views import SubmitTicketResponseView, TicketResponseListView, LocationListView, RegionListView, TicketCountView, PdfFileView, ArchivedView
...
urlpatterns = [
    ...
    path("archived/",ArchivedView.as_view())
]
